<script lang="ts">
  ...
  const dockVariants = cva(
    "mx-auto w-max h-[58px] p-4 flex gap-2 rounded-2xl border border-muted-foreground supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 backdrop-blur-md"
  );
